#  <img width="28" height="28" src="https://img.icons8.com/emoji/28/united-kingdom-emoji.png" alt="united-kingdom-emoji"/> How to discuss you morning or evening routine
...
Conditional sentences often use if to describe a situation (cause) that will lead to a particular result (consequence). They typically consist of two parts: ``the if clause (condition) and the main clause (result)``. For example: ``If you sleep well, you will feel refreshed``. (condition: sleeping well; result: feeling refreshed)
...
## <img width="28" height="28" src="https://img.icons8.com/emoji/28/united-kingdom-emoji.png" alt="united-kingdom-emoji"/>  Later
...
## <img width="28" height="28" src="https://img.icons8.com/emoji/28/united-kingdom-emoji.png" alt="united-kingdom-emoji"/> Could / Can
